#!/usr/bin/env python
# -*- coding: utf-8 -*-
#  comb_funcs.py Author "Nathan Wycoff <nathanbrwycoff@gmail.com>" Date 02.05.2018

# Functions related to enumerating all possibe choices of k items from n many total items without considering ordering.
